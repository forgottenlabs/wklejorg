...
from wklej.models import *

class Migration:
    
    def forwards(self, orm):
        
        # Adding field 'Wklejka.is_spam'
        db.add_column('wklej_wklejka', 'is_spam', orm['wklej.wklejka:is_spam'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Wklejka.is_spam'
        db.delete_column('wklej_wklejka', 'is_spam')
